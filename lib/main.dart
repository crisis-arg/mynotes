      ...
      child: Scaffold(
        ...
        body: BlocConsumer<CounterBloc, CounterState>(
          builder: (context, state) {
            final inValidValue =
                (state is CounterStateIvalidNumber) ? state.invalidValue : '';
            return Column(
              children: [
                Text('Current value => ${state.value}'),
                Visibility(
                  visible: state is CounterStateIvalidNumber,
...
class CounterStateIvalidNumber extends CounterState {
  final String invalidValue;

  const CounterStateIvalidNumber({
